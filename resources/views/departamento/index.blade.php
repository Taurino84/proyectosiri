            ...
            <div class="col-xl-12">
                <form action="{{route('departamento.index')}}" method="GET">
                    <div class="row my-1 mt-2">
                        <div class="col-sm-4">
                            <input type="text" name="texto" class="form-control" value="{{$texto}}" placeholder="Ingrese el Departamento">
                        </div>
                        <div class="col-auto">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><a href="{{route('departamento.edit',$departamento->idDepartamento)}}" class="btn btn-warning btn-sm">Editar</a> 
                                    ...
                                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal-delete-{{$departamento->idDepartamento}}">
                                        Eliminar
                                    </button>
                                </td>
